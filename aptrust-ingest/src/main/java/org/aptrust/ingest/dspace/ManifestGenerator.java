...
public class ManifestGenerator {
    ...
    public static void main(String [] args) throws JAXBException, FileNotFoundException, URISyntaxException {
        ...
        IngestManifest m = generateManifest(username, packageDir, dpnBound, accessConditions, "A manifest automatically generated by the ManifestGenerator tool.");
    ...
    public static IngestManifest generateManifest(String username, File packageDir, boolean dpnBound, String accessConditions, String ingestOperationName) throws URISyntaxException {
        IngestManifest m = new IngestManifest();
        ArrayList<IngestPackage> packages = new ArrayList<IngestPackage>();
        Description d = new Description();
        d.setName(ingestOperationName);
